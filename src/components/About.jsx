...
function About(props) {
    ...
    // const title = 'Мы делаем, а не говорим'
    // const subtitle = 'Отвечаем за сроки — возвращаем 0.5% от стоимости работ за каждый день просрочки или дарим месяц поддержки по тарифу “Минимальный”'
    // const additional = ''
    // const points = [ // : Array of Objects => { iconLink: , pointName: , pointText: } 
    //     {
    //         iconLink: '/images/image.webp',
    //         pointName: 'Айдентика',
    //         pointText: ['Продумаем систему визуальных коммуникаций вашего бренда от 100 т.р.'] /// ВМЕСТО <br> RICH TEXT В СТРЕПИ
    //     },
    //     {
    //         iconLink: '/images/image.webp',
    //         pointName: 'Сайт',
    //         pointText: ['Разработаем лендинг, веб-приложение или корпоративный сайт на современном стеке от 200 т.р.'] /// ВМЕСТО <br> RICH TEXT В СТРЕПИ
    //     },
    //     {
    //         iconLink: '/images/image.webp',
    //         pointName: 'Поддержка',
    //         pointText: ['Поможем на каждом этапе - от дизайна и копирайта, до работы отдела продаж от 100 т.р.'] /// ВМЕСТО <br> RICH TEXT В СТРЕПИ
    //     }
    // ]
    // const points2 = [ // : Array of Objects => { iconLink: , pointName: , pointText: } 
    //     {
    //         iconLink: '/images/image.webp',
    //         pointName: 'анализируем',
    //         pointText: ['Анализируем рынок, текущие показатели бизнеса и действия конкурентов']
    //     },
    //     {
    //         iconLink: '/images/image.webp',
    //         pointName: 'реализуем',
    //         pointText: ['Разрабатываем и внедряем в ваш бизнес решения для роста']
    //     },
    //     {
    //         iconLink: '/images/image.webp',
    //         pointName: 'поддерживаем',
    //         pointText: ['Помогаем и сопровождаем по всем необходимым задачам']
    //     }
    // ]
